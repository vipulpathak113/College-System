...
const ENDPOINTS = {
  ...
  GET_SINGLE_APPLICATION:
    HOST + "adminpanel/harlabhadmin/getsingleapplication/",
  ...
  GET_NON_DBT_APPLICATIONS:
    HOST + "adminpanel/harlabhadmin/getnondbtapplications/",
  NON_MONETARY_APPLICATIONS:
    HOST + "adminpanel/harlabhadmin/getnonmonetaryapplications/",
  TAKE_DOCUMENT_ACTION: HOST + "adminpanel/harlabhadmin/documentaction/",
  TAKE_DOCUMENT_SUGGESSTION_ACTION:
    HOST + "adminpanel/harlabhadmin/suggesteddocumentaction/",
  REVIEW_DOCUMENT_ACTION: HOST + "adminpanel/harlabhadmin/documentreviewlater/",
  CHANGE_APPLICATION_STATUS:
    HOST + "adminpanel/harlabhadmin/changeapplicationstatus/",
  ...
  COMPLETE_NON_MONETARY_BENEFIT:
    HOST + "adminpanel/harlabhadmin/completesubbenefit/",
  ...
  SEARCH_NON_MONETARY_APPLICATIONS:
    HOST + "adminpanel/harlabhadmin/searchnonmonetary/",
  ...
  HARLABH_DISTRICT_WISE_DATA_COUNT:
    HOST + "harlabhdashboard/districtwisedatacount/",
  HARLABH_COMPARE_ONBOARDING_STATUS:
    HOST + "harlabhdashboard/comparing_onboarding_status/",
