...
import KycDetails from './non_dbt_kyc_details';
...
export default class NonDBTCompleteTask extends React.Component {
	...
	goBack() {
		store.dispatch({type:"CLOSE_NON_DBT_COMPLETE_TASK"})
	}
				...
				{!this.state.showHome ?
					<div className="right-panel-content-bg">
						...
						<div className="benefit-description">
							<h3 className="upload-heading"> Upload proof : <span className="benefit-description-text">{this.state.benefitData.scheme_rule_set_sub_benefit__benefit} of ₹ {this.state.benefitData.scheme_rule_set_sub_benefit__value}</span></h3>
						</div>
