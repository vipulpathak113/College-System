...
export default class DocumentsRejectedApplication extends React.Component {
	...
	componentWillMount() {
		...
		network.send(bootupsettings.ENDPOINTS.SEARCH_APPLICATIONS, { "searchTerm": term, "searchType": type, "status": "documents_rejected", "size":15, pageNumber:previousPage }, "documents_rejected", function (response, component) { })
		store.subscribe(() => {
