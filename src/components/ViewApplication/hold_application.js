...
export default class HoldApplication extends React.Component {
	...
	componentWillMount() {
		...
		network.send(bootupsettings.ENDPOINTS.SEARCH_APPLICATIONS, { "searchTerm": term, "searchType": type, "status": "on_hold", "size":15, "pageNumber":previousPage }, "on_hold", function (response, component) { })
		store.subscribe(() => {
