...
export default class DocumentsApprovedApplication extends React.Component {
	...
	componentWillMount() {
		...
		easygov.send(bootupsettings.ENDPOINTS.SEARCH_APPLICATIONS, { "searchTerm": term, "searchType": type, "status": "documents_pending", "size":15, pageNumber:previousPage }, "documents_pending_tab", function (response, component) { })
		store.subscribe(() => {
