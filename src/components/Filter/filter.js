...
this.state={
    ...
    filterSelection(e){
        ...
        easygov.send(bootupsettings.ENDPOINTS.STUDENT_FILTER,{year:this.state.year,department:this.state.department,course:this.state.course},"STUDENT_FILTER", function (response, component) { })
      );
    }
    ...
    render(){
        ...
        return(
            <div className="right-panel-filter" >
              ...
              <FlatButton flat label="CLEAR FILTER" onClick={this.clearfilter.bind(this)} className="filterbtn"/>	
              </div>
            </div>
        )
    }
