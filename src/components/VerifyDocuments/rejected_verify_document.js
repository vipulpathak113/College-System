...
export default class RejectedVerifyDocuments extends React.Component {
	...
	componentDidMount() {
		...
		network.send(bootupsettings.ENDPOINTS.SEARCH_APPLICATIONS, { "searchTerm": "", "searchType": "", "status": "documents_rejected", "size": 15, pageNumber: previousPage }, "documents_rejected", function (response, component) { })
