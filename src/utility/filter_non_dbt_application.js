...
function clearSearchResults() {
	...
	easygov.send(bootupsettings.ENDPOINTS.GET_NON_DBT_APPLICATIONS, {"status": pageStatus, "searchTerm": "", "searchType": ""}, "GET_NON_DBT_APPLICATIONS", function (response, component) { })
}
function searchApplications() {
	...
	if(searchKey !== "" && searchPhrase !== ""){
		...
		easygov.send(bootupsettings.ENDPOINTS.GET_NON_DBT_APPLICATIONS, { "status": pageStatus, "searchTerm": searchPhrase, "searchType": searchKey }, "GET_NON_DBT_APPLICATIONS", function (response, component) { })
	}
